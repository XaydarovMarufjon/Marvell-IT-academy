let kurs_yozilish = document.querySelector("#kurs_yozilish");
let modal = document.querySelector(".modals");
kurs_yozilish.addEventListener("click", () => {
...
function is_active(event) {
  for (let index = 0; index < main_header_link.length; index++) {
    main_header_link.classList.remove("is-active");
  }
